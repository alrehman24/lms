...
<head>
    ...
    <link rel="stylesheet" href="onicons/2.0.1/css/ionicons.min.css">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('academic-year.create') }}" class="nav-link active">
                            ...
                            <li class="nav-item ">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('class.create') }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Record</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('fee-head.create') }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Record</p>
                                        </a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{ route('fee-structure.create') }}" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Add Record</p>
                                        </a>
                                    </li>
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ route('admin.change-password') }}" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Change Password</p>
                            </a>
                        </li>
